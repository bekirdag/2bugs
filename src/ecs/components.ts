...
export const DNA = defineComponent({
  ...
  metabolism: Types.f32,
  hungerThreshold: Types.f32,
  fatCapacity: Types.f32,
  hungerRestMultiplier: Types.f32,
  hungerSurvivalBufferScale: Types.f32,
  growthReserveBase: Types.f32,
  growthReserveGreedScale: Types.f32,
  satiationBase: Types.f32,
  satiationGreedScale: Types.f32,
  patrolThresholdMinScale: Types.f32,
  patrolThresholdMaxScale: Types.f32,
  initialEnergyBirthMultiplier: Types.f32,
  initialEnergySeedMultiplier: Types.f32,
  cowardice: Types.f32,
